...
CREATE TABLE `reports` (
    ...
    INDEX `idx_reports_users` (`users_id`)
);
...
CREATE TABLE `depression_reports` (
    ...
    INDEX `idx_depression_report` (`report_id`),
    INDEX `idx_depression_user` (`users_id`),
...
CREATE TABLE `anxiety_reports` (
    ...
    INDEX `idx_anxiety_report` (`report_id`),
    INDEX `idx_anxiety_user` (`users_id`),
...
CREATE TABLE `diagnose_ai_reports` (
    ...
    INDEX `idx_diagAI_report` (`report_id`),
    INDEX `idx_diagAI_user` (`users_id`),
